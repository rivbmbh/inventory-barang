                ...
                <form action="<?= base_url('transaction/update/' . $transaction['id']) ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="item_id" aria-label="Default select example">
                            ...
                            <option value="<?= $row['id']; ?>"
                                <?= $row['id'] == $transaction['item_id'] ? 'selected' : '' ?>><?= $row['name']; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="type" aria-label="Default select example">
                            ...
                            <option value="in" <?= $transaction['type'] == 'in' ? 'selected' : '' ?>>Goods In</option>
                            <option value="out" <?= $transaction['type'] == 'out' ? 'selected' : '' ?>>Goods Out
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
